...
namespace CarPooling.Data.Migrations
{
    ...
    [Migration("20230815131202_initial")]
            ...
            modelBuilder.Entity("CarPooling.Data.Models.Travel", b =>
                {
                    ...
                    b.Property<double>("EstimatedTravelDuration")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TravelUser", b =>
                {
                    ...
                    b.Property<int>("PassengersTravelHistoryId")
                        .HasColumnType("int");

                    b.HasKey("PassengersId", "PassengersTravelHistoryId");

                    b.HasIndex("PassengersTravelHistoryId");
            ...
            modelBuilder.Entity("TravelUser", b =>
                {
                    ...
                    b.HasOne("CarPooling.Data.Models.Travel", null)
                        .WithMany()
                        .HasForeignKey("PassengersTravelHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
