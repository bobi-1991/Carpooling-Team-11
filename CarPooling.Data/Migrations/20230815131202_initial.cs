        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanSmoke = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedTravelDuration = table.Column<double>(type: "float", nullable: false),
                    ArrivalTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TravelDistance = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Travels_Addresses_EndLocationId",
                        column: x => x.EndLocationId,
                        principalTable: "Addresses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Travels_Addresses_StartLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Feedbacks_AspNetUsers_PassengerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassengersTravelHistoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TravelUser", x => new { x.PassengersId, x.PassengersTravelHistoryId });
                    table.ForeignKey(
                        name: "FK_TravelUser_AspNetUsers_PassengersId",
                        column: x => x.PassengersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TravelUser_Travels_PassengersTravelHistoryId",
                        column: x => x.PassengersTravelHistoryId,
                        principalTable: "Travels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Travels_EndLocationId",
                table: "Travels",
                column: "EndLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Travels_StartLocationId",
                table: "Travels",
                column: "StartLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelUser_PassengersTravelHistoryId",
                table: "TravelUser",
                column: "PassengersTravelHistoryId");
